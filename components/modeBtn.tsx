...
function ModeBtn() {
  ...
  return (
    ...
    >
      <div
        id="theme-indicator"
        className={`w-16 h-8 text-xl text-neutral rounded-3xl flex justify-around items-center lg:w-24 lg:h-12 lg:text-3xl transition-all duration-300 ${
          theme === "dark" ? "-translate-x-1/2" : ""
        }`}
      >
        <Icon size="medium">
